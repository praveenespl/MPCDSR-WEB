...
@Component({
  selector: 'kt-mapstillbirth',
  templateUrl: './mapstillbirth.component.html',
  styleUrls: ['./mapstillbirth.component.scss']
})
export class MapstillbirthComponent implements  OnInit, AfterViewInit, OnDestroy, OnChanges {
  ...
  ngOnInit() {    
    ...
    console.log('this.user.accessupto',this.user.accessupto);
