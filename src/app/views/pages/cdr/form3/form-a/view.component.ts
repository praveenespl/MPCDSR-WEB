...
import { getAllCDRDeathBasedOnDays, getAllCDRDeathWhoseFbirDone } from "../../../../../utilities/functions";
...
export class ViewComponent implements OnInit, DataList {
	...
	getList() {
		// this.cdrForm1Service.count().subscribe(({ count }) => {
		...
		merge(this.sort.sortChange, this.paginator.page)
			.pipe(
				...
				map((data) => {
					...
					const cdrDeaths = getAllCDRDeathBasedOnDays(cdrDeathsWhoseFBIRDone, 28, "lte");
